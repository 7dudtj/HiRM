...
# svdmodule_list=("sparsesvd" "scipy" "fbpca" "sklearn-rand" "torch_cuda")
svdmodule_list=("fbpca" "sklearn-rand" "torch_cuda" "cupy" "sparsesvd")
...
for dataset in "${dataset_list[@]}"; do
    for svdmodule in "${svdmodule_list[@]}"; do
        for svdvalue in "${svdvalue_list[@]}"; do
            ...
            echo python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 1]" > "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_1.log"
            python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 1]" >> "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_1.log"

            echo python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 2]" > "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_2.log"
            python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 2]" >> "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_2.log"

            echo python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 3]"  > "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_3.log"
            python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['butterworth', 3]" >> "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_butterworth_3.log"

            echo python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['gfcf-linear-autoencoder']"  > "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_gfcf-linear-autoencoder_0.3.log"
            python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['gfcf-linear-autoencoder']"  >> "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_gfcf-linear-autoencoder_0.3.log"
            ...
            echo python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['inverse']" > "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_sigmoid-low-pass.log"
            python main.py --dataset=$dataset --topks="[20]" --simple_model="exp2" --expdevice=${DEVICE} --svdvalue=$svdvalue --svdtype=$svdmodule --filter="['inverse']" >> "$CreateDIR/${dataset}_${svdmodule}_${svdvalue}_sigmoid-low-pass.log"
