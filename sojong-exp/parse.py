...
def parse_args():
    ...
    parser.add_argument('--filter', nargs='?', default="['ideal-low-pass']", help='[filter_name, option] - [linear], [ideal-low-pass], [gaussian, mu], [heat-kernel, alpha], [butterworth, 1|2|3], [gfcf-linear-autoencoder, mu], [gfcf-Neighborhood-based, ], [sigmoid-low-pass, ]')
